...
! function (a) {
    ...
    a.fn.filer = function (b) {
                    ...
                    _thumbCreator: {
                        ...
                        _box: function (b) {
                            ...
                            if (i.length < 1) {
                                ...
                                c.find(".jFiler-items").remove(), i = a('<table class="jFiler-items jFiler-row" style="width:100%"></table>'), e.prop("jFiler").listEl = i, i.append(m._assets.textParse(l.templates.box)).appendTo(c), i.on("click", l.templates._selectors.remove, function (c) {
                                    c.preventDefault();
        ...
        templates: {
            ...
            item: '<tr class="jFiler-item"><td style="width:100px">File</td><td style="width:159px" class="jFiler-item-title" title="{{fi-name}}">{{fi-name | limitTo:500}}</td><td style="width:100px" class="jFiler-item-assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></td></tr>',
            itemAppend: '<tr class="jFiler-item"><td style="width:100px">File</td><td style="width:159px" class="jFiler-item-title">{{fi-name | limitTo:500}}</td><td style="width:100px" class="jFiler-item-assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></td></tr>',
